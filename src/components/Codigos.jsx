...
const Codigos = () => {
  ...
  const capturarTabla = (tabla) => {
    ...
    html2canvas(tabla).then((canvas) => {
        ...
        const nombreSerie = tabla.querySelector(".celda-codigos-serie")?.textContent.trim() || "captura";
  ...
  return (
    <div className="contenedor-codigos-joyvolt">
      ...
      <div className="separador-codigos-joyvolt"></div>
      <span className="detalle-codigos">(Entregado sabado 08 de marzo de 2025. Por fernando.)</span>
      <span className="detalle-codigos">(Lo trae una camioneta de urbanos verdes)</span>
      ...
      <div className="separador-codigos-joyvolt"></div>
      <span className="detalle-codigos">(Entregado sabado 08 de marzo 2025. Por fernando)</span>
      <span className="detalle-codigos">(Lo trae una camioneta de urbanos verdes)</span>
